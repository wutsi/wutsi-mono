...
public class MarketplaceManagerApiBuilder {
    public fun build(
        env: Environment,
        mapper: ObjectMapper,
        ...
        .logger(feign.slf4j.Slf4jLogger(MarketplaceManagerApi::class.java))
        ...
        .target(MarketplaceManagerApi::class.java, env.url)
}
