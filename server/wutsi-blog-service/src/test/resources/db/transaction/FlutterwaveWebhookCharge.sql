...
INSERT INTO T_TRANSACTION(id, idempotency_key, status, type, wallet_fk, store_fk, product_fk, amount, fees, net,currency,payment_method_owner, payment_method_number, payment_method_type, gateway_type, user_fk, email)
VALUES
    ('100', 'pending-2-success', 2, 2, '1', '100', 101, 10000, 0, 0, 'XAF', 'Roger Milla', '+237911111111', 1, 1, 4, 'tchbansi@hotmail.com'),
    ('101', 'success-101', 1, 2, '1', '100', 101, 5000, 500, 4500, 'XAF', 'Roger Milla', '+237911111111', 1, 1, 5, 'u5@gmail.com'),
    ('102', 'pending-2-success-ebook', 2, 2, '1', '100', 102, 1000, 0, 1000, 'XAF', 'Roger Milla', '+237911111111',1, 1, 4, 'tchbansi@hotmail.com'),

    ('200', 'pending-2-failed', 2, 2, '2', '200', 201, 10000, 0, 0, 'XAF', 'Roger Milla', '+237911111111', 1, 1, 5, 'u5@gmail.com'),
    ('201', 'success-201', 1, 2, '2', '200', 201, 500, 50, 450, 'XAF', 'Roger Milla', '+237911111111', 1, 1, 5, 'u5@gmail.com'),

    ('300', 'success', 1, 2, '3', '300', 301, 10000, 1000, 9000, 'XAF', 'Roger Milla', '+237911111111', 1, 1, 6, 'u6@gmail.com'),
    ('310', 'failed', 3, 2, '3', '300', 301, 10000, 0, 0, 'XAF', 'Roger Milla', '+237911111111', 1, 1, 6, 'u6@gmail.com')
;
