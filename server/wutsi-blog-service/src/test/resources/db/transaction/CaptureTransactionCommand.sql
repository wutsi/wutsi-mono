...
INSERT INTO T_TRANSACTION(id, idempotency_key, status, type, wallet_fk, amount, net, currency, payment_method_owner, payment_method_number, payment_method_type, gateway_type, gateway_transaction_id)
VALUES
    ('100', 'charge-100', 2, 2, 1, 1000, 1000, 'XAF', 'Roger Milla', '+237911111111', 1, 1, '100100'),
    ('200', 'charge-200', 2, 2, 1, 1000, 1000, 'XAF', 'Song Bahanack', '+237911111100', 1, 1, '200200')
;