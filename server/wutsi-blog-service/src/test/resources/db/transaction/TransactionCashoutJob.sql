INSERT INTO T_USER(id, subscriber_count, name, email, full_name, picture_url, website_url, login_count, biography, blog) VALUES
    ...
    (10, 1, 'Yo', 'yo.man@gmail.com', 'Yo Man', null, null, 1, null, false)
;
...
INSERT INTO T_WALLET(id, user_fk, currency, country, balance, account_number, account_owner, account_type, next_cashout_date) VALUES
    ...
    ('10', 10, 'XOF', 'CM', 1000, '+225999999992', 'Jane Doe', 1, date_sub(now(), interval 1 day))
;
...
INSERT INTO T_TRANSACTION(id, idempotency_key, status, type, wallet_fk, user_fk, amount, fees, net, currency, payment_method_owner, payment_method_number, payment_method_type, gateway_type, description, gateway_transaction_id, email, creation_date_time)
    VALUES
        ...
        ('101', 'success-charge-101--', 1, 2, '1', null, 4000, 0, 4000, 'XAF', 'Roger Milla', '+237911111111', 1, 1, 'Sample Transaction', '100-101', 'roger.milla@gmail.com', date_sub(now(), interval 1 day)),
        ...
        ('103', 'pending-donation-103', 2, 1, '1', null, 1000, 0, 0, 'XAF', 'Omam Biyick', '+237911111112', 1, 1, 'Sample Transaction', '100-103', 'roger.milla@gmail.com', now()),
        ('104', 'success-donation-104', 1, 1, '1', null, 1000, 0, 900, 'XAF', 'Roger Milla', '+237911111111', 1, 1, 'Sample Transaction', '100-104', 'roger.milla@gmail.com', date_sub(now(), interval 10 day)),

        ('200', 'success-donation-200', 1, 1, '10', null, 1000, 0, 6000, 'XAF', 'Roger Milla', '+237911111111', 1, 1, 'Sample Transaction', '200-200', 'roger.milla@gmail.com', date_sub(now(), interval 10 day))
    ;
