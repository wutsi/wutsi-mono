INSERT INTO T_USER(id, super_user, name, email, full_name) VALUES
  ...
  (311, false, 'john300', 'john300.partner@gmail.com', 'Yo Man')
;
...
INSERT INTO T_STORY(id, user_fk, title, tagline, summary, thumbnail_url, source_url, language, status, published_date_time) VALUES
  ...
  (300, 311, 'Story201', 'Sample Tagline', 'This is summary', 'http://www.img.com/goo.png', 'http://www.test.com/1/1/test.txt', 'en', 1, '2018-01-30')
;

UPDATE T_USER SET pin_story_id=200 WHERE id=211;
UPDATE T_USER SET pin_story_id=300 WHERE id=311;
