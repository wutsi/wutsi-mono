...
INSERT INTO T_PRODUCT(id, external_id, store_fk, status, title, image_url, file_url, available, price, category_fk)
VALUES (100, '101', '1', 0, 'product 101', 'https://picsum/101', 'https://file.com/101.pdf', true, 1000, 1001),
       (102, '102', '1', 0, 'product 102', 'https://picsum/102', 'https://file.com/102.pdf', false, 2000, 1001),
       (103, '103', '1', 0, 'product 103', 'https://picsum/103', 'https://file.com/102.pdf', true, 500, 1001)
;
