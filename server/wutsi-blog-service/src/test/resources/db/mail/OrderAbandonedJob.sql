...
INSERT INTO T_STORE(id, user_fk, currency, abandoned_order_discount) VALUES ('10', 10, 'XAF', 15);
...
INSERT INTO T_TRANSACTION(id, idempotency_key, status, type, wallet_fk, store_fk, product_fk, amount, fees, net, currency, payment_method_owner, payment_method_number, payment_method_type, gateway_type, user_fk, email, creation_date_time, error_code)
VALUES
    ('100', 'failed-100', 3, 2, '10', '10', 100, 1000, 0, 0, 'XAF', 'Herve T', '+237911111111', 1, 1, 2, 'herve.tchepannou@gmail.com', '2020-10-03 08:00:00', 'NOT_ENOUGH_FUNDS'),
    ('101', 'failed-101', 3, 2, '10', '10', 100, 1000, 0, 0, 'XAF', 'Herve T', '+237911111111', 1, 1, 2, 'herve.tchepannou@gmail.com', '2020-10-03 09:00:00', 'NOT_ENOUGH_FUNDS'),
    ('110', 'failed-110', 3, 2, '10', '10', 110, 2000, 0, 0, 'XAF', 'Bansi', '+237911111112', 1, 1, null, 'tchbansi@hotmail.com', '2020-10-03 10:00:00', 'NOT_ENOUGH_FUNDS'),
    ('111', 'failed-111', 1, 2, '10', '10', 110, 2000, 0, 0, 'XAF', 'Bansi', '+237911111112', 1, 1, null, 'tchbansi@hotmail.com', '2020-10-04 11:00:00', 'NOT_ENOUGH_FUNDS'),
    ('200', 'failed-200', 3, 2, '10', '10', 100, 1000, 0, 0, 'XAF', 'Y Vois Rien', '+225911111122', 1, 1, null, 'herve.tchepannou.ci@gmail.com', '2020-10-03 08:00:00', 'NOT_ENOUGH_FUNDS')
;
