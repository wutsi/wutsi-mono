INSERT INTO T_USER(id, super_user, name, email, full_name, picture_url, login_count, active) VALUES
    (1, false, 'ray.sponsible', 'ray.sponsible@gmail.com', 'Ray Sponsible', 'https://picture.com/ray.sponsible', 5, true),
