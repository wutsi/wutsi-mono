INSERT INTO T_USER(id, subscriber_count, name, email, full_name, picture_url, website_url, login_count, biography, blog) VALUES
    (1, 1, 'ray.sponsible', 'ray.sponsible@gmail.com', 'Ray Sponsible', 'https://picture.com/ray.sponsible', 'https://me.com/ray.sponsible', 5, 'Angel investor', true)
  ...
  , (4, 1, 'subscribe.with.email', 'subscribe.with.email@gmail.com', 'Subscribe with Email', null, null, 1, null, false)
;
