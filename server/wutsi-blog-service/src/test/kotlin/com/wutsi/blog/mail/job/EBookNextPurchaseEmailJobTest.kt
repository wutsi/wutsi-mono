...
@Sql(value = ["/db/clean.sql", "/db/mail/EBookNextPurchaseEmailJob.sql"])
class EBookNextPurchaseEmailJobTest : AbstractMailerTest() {
    @Autowired
    private lateinit var job: EBookNextPurchaseEmailJob
    ...
    fun run() {
        ...
        val events = eventStore.events(
            ...
            entityId = "101",
            type = EventType.PRODUCT_NEXT_PURCHASE_EMAIL_SENT_EVENT,
        )
