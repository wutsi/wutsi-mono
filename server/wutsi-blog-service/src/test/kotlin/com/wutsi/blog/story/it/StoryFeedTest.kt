    ...
    fun run() {
        ...
        assertEquals(
            """
                ...
                1,CAN: Cameroon vs. Argentina: 1-0.,1,Ray Sponsible,en,101,art,100,art-entertainment,http://localhost:8081/read/1/can-cameroon-vs-argentina-1-0,CAN-2021,This is an historic day..
                2,Trump de retour,2,Roger Milla,fr,202,business,200,industry,http://localhost:8081/read/2/trump-de-retour,Trump|Politics,Trump re-elu president une fois de plus!
            """.trimIndent(),
            content.trimIndent(),
        )
    }
