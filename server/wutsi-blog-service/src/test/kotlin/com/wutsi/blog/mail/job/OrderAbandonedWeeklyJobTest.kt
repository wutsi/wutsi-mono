...
@Sql(value = ["/db/clean.sql", "/db/mail/OrderAbandonedWeeklyJob.sql"])
class OrderAbandonedWeeklyJobTest : AbstractMailerTest() {
    @Autowired
    private lateinit var job: OrderAbandonedWeeklyJob
    ...
    override fun setUp() {
        ...
        val date = fmt.parse("2020-10-11 08:45:00")
    ...
    fun run() {
        ...
        val events = eventStore.events(
            ...
            entityId = "100",
            userId = "2",
            type = EventType.TRANSACTION_ABANDONED_WEEKLY_EMAIL_SENT_EVENT,
        )
