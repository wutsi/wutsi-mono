...
class AdsClickKpiImporterTest {
    ...
    @Autowired
    private lateinit var importer: AdsClickKpiImporter
    ...
    fun import() {
        ...
        verify(persister).persistAds(date, KpiType.CLICK, "100", 10)
        verify(persister).persistAds(date, KpiType.CLICK, "200", 100)
