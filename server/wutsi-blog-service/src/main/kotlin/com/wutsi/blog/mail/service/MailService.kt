...
class StoryService(
    ...
    private fun sendEmail(story: StoryEntity): Boolean {
        val subscriptions = subscriptionDao.findByUserIdIn(listOf(story.userId))
        subscriptions.forEach {
            eventStream.enqueue(
                type = EventType.SEND_STORY_EMAIL_NOTIFICATION_COMMAND,
