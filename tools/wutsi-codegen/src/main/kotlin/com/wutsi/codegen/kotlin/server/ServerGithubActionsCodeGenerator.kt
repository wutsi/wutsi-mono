...
class ServerGithubActionsCodeGenerator : AbstractGithubActionsCodeGenerator() {
    ...
    override fun toMustacheScope(openAPI: OpenAPI, context: Context): Map<String, Any?> {
        val dbname = DatabaseUtil.toDatabaseName(context.apiName).uppercase()
        return mapOf(
            ...
            "secrets.MYSQL_USERNAME_TEST" to "{{secrets.MYSQL_USERNAME_${dbname}_TEST}}",
            "secrets.MYSQL_PASSWORD_TEST" to "{{secrets.MYSQL_PASSWORD_${dbname}_TEST}}",
            "secrets.MYSQL_URL_TEST" to "{{secrets.MYSQL_URL_${dbname}_TEST}}",
            ...
            "secrets.MYSQL_USERNAME_PROD" to "{{secrets.MYSQL_USERNAME_${dbname}_PROD}}",
            "secrets.MYSQL_PASSWORD_PROD" to "{{secrets.MYSQL_PASSWORD_${dbname}_PROD}}",
            "secrets.MYSQL_URL_PROD" to "{{secrets.MYSQL_URL_${dbname}_PROD}}",
