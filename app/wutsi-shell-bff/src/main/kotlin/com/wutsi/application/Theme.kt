...
object Theme {
    ...
    const val COLOR_WHATSAPP = "#25D366"
    ...
    const val ICON_ARROW_FORWARD = "ee8d"
    const val ICON_ARROW_BACK = "ee85"
    const val ICON_BANK = "ee32"
    const val ICON_BAR_CHART = "f3d9"
    const val ICON_BUSINESS = "ef0b"
    const val ICON_CALENDAR = "ef11"
    const val ICON_CAMERA = "f60b"
    const val ICON_CANCEL = "ef28"
    const val ICON_CART = "f37f"
    const val ICON_CASHIN = "f1e0"
    const val ICON_CASHOUT = "f356"
    const val ICON_CATEGORY = "ef37"
    const val ICON_CHAT = "ef44"
    ...
    const val ICON_LOGOUT = "f199"
    const val ICON_MOBILE = "f28d"
    const val ICON_MONEY = "f1dd"
    const val ICON_MORE = "f8d9"
    const val ICON_MOTORCYCLE = "f1f0"
    const val ICON_NEWSPAPER = "f0639"
    const val ICON_ORDER = "f16c"
    const val ICON_PIN = "f2aa"
    const val ICON_PLACE = "f2ac"
    const val ICON_POINT_OF_SALES = "f2bb"
    const val ICON_POLICY = "f2bc"
    const val ICON_PURCHASES = "f37b"
    const val ICON_PENDING = "f269"
