...
object Page {
    ...
    const val SETTINGS_FUNDRAISING = "page.settings.fundraising"
    const val SETTINGS_FUNDRAISING_EDITOR = "page.settings.fundraising.editor"
    const val SETTINGS_FUNDRAISING_ENABLE = "page.settings.fundraising.enable"
    const val SETTINGS_FUNDRAISING_STATS = "page.settings.fundraising.stats"
    ...
    fun getSettingsFundraisingEditorUrl() = "${getSettingsFundraisingUrl()}/editor"
    fun getSettingsFundraisingActivateUrl() = "${getSettingsUrl()}/fundraising/activate"
    fun getSettingsFundraisingStatsUrl() = "${getSettingsFundraisingUrl()}/stats"
