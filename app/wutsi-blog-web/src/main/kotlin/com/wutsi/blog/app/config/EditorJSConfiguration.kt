...
import com.wutsi.blog.app.service.ejs.interceptor.ProductEJSInterceptor
...
class EditorJSConfiguration(
    ...
    fun ejsFilterSet(
        ...
        arrayListOf(
            ...
            AttachesEJSFilter(),
            LinkEJSFilter(websiteUrl, liretamaService, youscribeService), // IMPORTANT: Must be the last!!!
    ...
    fun ejsInterceptorSet(): EJSInterceptorSet =
        EJSInterceptorSet(
            interceptors = listOf(
                ProductEJSInterceptor(requestContext),
